...
class AdvanceOrder:public Order{
    ...
    public:
        AdvanceOrder();
        AdvanceOrder(Player* issuer,int numArmies, Territory* source, Territory* target);
...
class BlocakdeOrder : public Order{
    private:
        Territory* target;
    public:
        BlocakdeOrder();
        BlocakdeOrder(Player* issuer,Territory* target);
        BlocakdeOrder(const BlocakdeOrder& other)=default;
        BlocakdeOrder& operator=(const BlocakdeOrder& other)=default;
        ~BlocakdeOrder()override = default;
        //Getters
        Territory* getTargetTerritory() const;
        //Setters
        void setTargetTerritory(Territory* target);
...
class AirliftOrder : public Order{
    ...
    public:
        AirliftOrder();
        AirliftOrder(Player* issuer,int numArmies, Territory* target, Territory* source);
