...
// continents and territories ids are 0 based and are modified from the text
// file.
...
public:
  ...
  vector<vector<bool *> *> *borders; // borders[i][j] -> is there a border
                                     // between territory with id i and j
